...
const Onboarding2: React.FC<{ navigation: any }> = ({ navigation }) => {
      ...
      <PageContainer>
        <View style={Onboarding1Styles.contentContainer}>
          ...
          <View style={Onboarding1Styles.titleContainer}>
            <Text style={Onboarding1Styles.title}>{translate('bank_screens.onboarding_Request_Money')}</Text>
          </View>

          <Text style={Onboarding1Styles.description}>{translate('bank_screens.onboarding_You_can_request')}</Text>
