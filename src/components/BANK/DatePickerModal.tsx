...
const DatePickerModal: React.FC<DatePickerModalProps> = ({ open, startDate, selectedDate, onClose, onChangeStartDate }) => {
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <TouchableOpacity onPress={handleOnPressStartDate}>
            <Text style={{ color: 'white' }}>{translate('bank_components.Close')} </Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
