...
(1, 'admin', 'admin@gmail.com', '', '09000000', '18454587891642651833.jpg', '1', '$2a$12$XL0y.w8hk1XyIiXoq3IZk.RTAtyZiEViTxhqsTOBYuXBqkCL7Zj1y', 'OOduBpPhFSS5Mb5crU0fOxJwlACloaFYx3lKRbRmC8TxIhFGtMFTDKOrBUez', 'super-admin', 726094, NULL, '2022-02-14 22:11:28');
...
CREATE TABLE `agents` (
  ...
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '1 => ''active'', 0 => ''banned'' , 2 => ''agent request''',
  `email_verified` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_code` int DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `two_fa_status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `two_fa` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  ...
  `business_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `api_creds` (
  `id` bigint UNSIGNED NOT NULL,
  `merchant_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `api_deposits` (
  ...
  `currency_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` varchar(4) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `txn_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `api_payment_processes` (
  ...
  `method_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `wallet_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `blog_categories` (
  ...
  `status` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(7, 24, 'Brazil', 'BR', '+55', '15', 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/BR.svg', '2024-09-22 20:03:47', '2024-09-22 20:03:47'),
(8, 26, 'Bolivia', 'BO', '+591', '18', 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/BO.svg', '2024-09-22 20:03:47', '2024-09-22 20:03:47');
...
CREATE TABLE `currencies` (
  `id` bigint UNSIGNED NOT NULL,
  `default` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '"1" => default, "0" => not default',
  `symbol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `curr_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '"1" => fiat, "2" => crypto',
  `status` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '"1" => active, "0" => inactive',
...
(1, '0', '$', 'USD', 'United State Dollar', '1', '1', '1.0000000000', '2021-12-20 04:12:58', '2024-09-22 20:02:53'),
(4, '0', '€', 'EUR', 'European Currency', '1', '1', '0.9055350000', '2021-12-20 04:12:58', '2024-10-08 22:43:47'),
...
(15, '1', 'R$', 'BRL', 'Real Brasileiro', '1', '1', '5.5573000000', '2024-09-22 20:02:53', '2024-10-08 22:46:23'),
(18, '1', 'Bs', 'BOB', 'Boliviano da Bolivia', '1', '1', '6.8600000000', '2024-09-22 20:02:53', '2024-10-08 22:45:29');
...
CREATE TABLE `deposits` (
  ...
  `user_type` varchar(1) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `txn_id` varchar(222) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `amount` double NOT NULL DEFAULT '0',
  `method` int NOT NULL,
  `currency_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `invoice` int DEFAULT NULL,
  `currency_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `trx_details` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `disputes` (
  `id` bigint UNSIGNED NOT NULL,
  `escrow_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `email_templates` (
  ...
  `sms` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `codes` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `escrows` (
  `id` bigint UNSIGNED NOT NULL,
  `trnx` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recipient_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(20,10) NOT NULL,
  `pay_charge` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1 = sender pay charge, 0 = receiver pa charge',
  `charge` decimal(20,10) NOT NULL,
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 = on-hold, 1 = release, 3 = disputed\r\n',
  `dispute_created` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `returned_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `fund_requests` (
  `id` bigint UNSIGNED NOT NULL,
  `agent_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `unique_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(18,8) NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `collect` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `generalsettings` (
  `id` int NOT NULL,
  `curr_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `curr_sym` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '$',
  ...
  `mail_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `is_tawk` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `tawk_id` varchar(222) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_verify` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `is_cookie` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cookie_btn_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cookie_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `is_maintenance` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `maintenance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `registration` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `kyc` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `sms_notify` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `email_notify` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `allowed_email` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contact_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recaptcha` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  `fiat_access_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `crypto_access_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cookie` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `two_fa` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
...
(1, 'BRL', 'R$', '1571567292logo.png', '1558572841646281442.png', '5480339181644482400.png', 'DBRBANK', '1564224328loading3.gif', 'sandbox.smtp.mailtrap.io', 'php_mailer', '2525', '77c8df7c3e0779', '509dc95e1382f5', 'tls', 'dbrbanktest11@gmail.com', 'DBRbankTest', '5B53F1', '0', '6124fa49d6e7610a49b1c136/1fds73cxyZ', '0', '0', 'cookie_btn_text', NULL, '0', 'Site Down', '1', '1', '0', '0', NULL, '+88000000000', '0', '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI', NULL, 'e02535b70998cade1035fbe04e50b8dd', '91b63a445b659202b6449e8611f231f9', '{\"status\":\"1\",\"button_text\":\"Allow Cookie\",\"cookie_text\":\"Our site use cookies when you visit our website, including any other media form, mobile website, or mobile application related or connected to help customize the site and improve your experience.\"}', '1', '{\"Hogar\":{\"title\":\"Hogar\",\"dropdown\":\"no\",\"href\":\"https:\\/\\/web.symma.online\",\"target\":\"self\"},\"Acerca-de\":{\"title\":\"Acerca de\",\"dropdown\":\"no\",\"href\":\"https:\\/\\/web.symma.online\\/about\",\"target\":\"self\"},\"API\":{\"title\":\"API\",\"dropdown\":\"no\",\"href\":\"https:\\/\\/web.symma.online\\/api-documentation\",\"target\":\"self\"},\"Blogs\":{\"title\":\"Blogs\",\"dropdown\":\"no\",\"href\":\"https:\\/\\/web.symma.online\\/blogs\",\"target\":\"self\"},\"Contacto\":{\"title\":\"Contacto\",\"dropdown\":\"no\",\"href\":\"https:\\/\\/web.symma.online\\/contact\",\"target\":\"self\"}}');
...
CREATE TABLE `invoices` (
  ...
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `invoice_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `charge` decimal(20,10) NOT NULL,
  `final_amount` decimal(20,10) NOT NULL,
  `get_amount` decimal(20,10) NOT NULL,
  `payment_status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '1 => paid, 0 => not paid',
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '1 => published, 0 => not published , 2 => cancel',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `inv_items` (
  `id` bigint UNSIGNED NOT NULL,
  `invoice_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(20,10) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `kyc_forms` (
  ...
  `type` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '"1" = input, "2" = file, "3" = textarea',
  `label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `required` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '"1" = yes, "0" = no',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `login_logs` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `merchant_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `agent_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Unknown',
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Unknown',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(106, NULL, NULL, NULL, '177.37.234.219', 'Brazil', 'Recife', '2024-09-23 01:38:25', '2024-09-23 01:38:25'),
(107, '13', NULL, NULL, '177.37.234.219', 'Brazil', 'Recife', '2024-09-23 01:43:01', '2024-09-23 01:43:01'),
(108, '13', NULL, NULL, '177.37.234.219', 'Brazil', 'Recife', '2024-09-23 03:31:34', '2024-09-23 03:31:34'),
(109, '13', NULL, NULL, '177.37.234.219', 'Brazil', 'Recife', '2024-09-23 14:13:34', '2024-09-23 14:13:34'),
(110, '13', NULL, NULL, '177.37.234.219', 'Brazil', 'Recife', '2024-09-23 21:02:21', '2024-09-23 21:02:21'),
(111, NULL, NULL, NULL, '181.188.167.42', 'Bolivia', 'Santa Cruz', '2024-09-23 22:45:10', '2024-09-23 22:45:10'),
(112, NULL, NULL, NULL, '177.33.139.93', 'Brazil', 'São Paulo', '2024-09-24 13:21:54', '2024-09-24 13:21:54'),
(113, NULL, NULL, NULL, '179.228.122.118', 'Brazil', 'Santo André', '2024-09-26 18:48:06', '2024-09-26 18:48:06'),
(114, NULL, NULL, NULL, '179.228.122.118', 'Brazil', 'Santo André', '2024-09-26 21:01:39', '2024-09-26 21:01:39'),
(115, '2', NULL, NULL, '179.228.122.118', 'Brazil', 'Santo André', '2024-09-26 21:52:08', '2024-09-26 21:52:08'),
(116, NULL, NULL, NULL, '179.228.122.118', 'Brazil', 'Santo André', '2024-09-27 06:04:55', '2024-09-27 06:04:55'),
(117, NULL, NULL, NULL, '177.33.139.93', 'Brazil', 'São Paulo', '2024-10-01 01:26:26', '2024-10-01 01:26:26'),
(118, NULL, NULL, NULL, '179.228.122.118', 'Brazil', 'Santo André', '2024-10-01 06:41:59', '2024-10-01 06:41:59'),
(119, '1', NULL, NULL, '191.13.208.23', 'Brazil', 'Praia Grande', '2024-10-02 02:19:48', '2024-10-02 02:19:48'),
(120, '15', NULL, NULL, '177.33.139.93', 'Brazil', 'São Paulo', '2024-10-02 22:54:22', '2024-10-02 22:54:22'),
(121, '15', NULL, NULL, '177.33.139.93', 'Brazil', 'São Paulo', '2024-10-03 02:56:02', '2024-10-03 02:56:02'),
(122, '15', NULL, NULL, '177.33.139.93', 'Brazil', 'São Paulo', '2024-10-03 17:15:24', '2024-10-03 17:15:24'),
(123, NULL, NULL, NULL, '185.209.31.200', 'Russia', 'Moscow', '2024-10-07 16:24:21', '2024-10-07 16:24:21');
...
CREATE TABLE `merchants` (
  ...
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `email_verified` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verification_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_code` int DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc_status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `kyc_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `kyc_reject_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'merchant', 'merchant', 'merchant@gmail.com', NULL, '+595993547294', 'Asuncion', NULL, 'asuncion', NULL, '1', '0', NULL, NULL, '$2y$10$Ny1onDOojHfLeA2aUdV0w.LSKzEqeLIP0RfWL23Adsjim77pi/w9O', NULL, '1', NULL, NULL, NULL, NULL, '0', '0', NULL, '2023-09-18 21:46:32', '2023-10-01 16:55:55');
...
CREATE TABLE `merchant_payments` (
  ...
  `web_hook` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `custom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cancel_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `success_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `modules` (
  ...
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `kyc` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'transfer-money', '1', '1', NULL, '2023-10-01 15:07:55'),
...
CREATE TABLE `payments` (
  ...
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trnx` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gateway_trx` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` decimal(20,10) NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `payment_gateways` (
  ...
  `checkout` varchar(1) NOT NULL DEFAULT '1',
  `status` varchar(1) NOT NULL DEFAULT '1',
  `subscription` varchar(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(103, 'App\\Models\\User', 2, 'wallet', '0285da9676542f64e29b6d75ec8d12b879d1da11acbbbff64297e805a6332a3c', '[\"*\"]', NULL, NULL, '2024-09-26 18:41:20', '2024-09-26 18:41:20'),
(104, 'App\\Models\\User', 2, 'wallet', '9a70e844042394556194de25ba60465455de1689041a7e05cd347710df6112aa', '[\"*\"]', NULL, NULL, '2024-09-26 18:46:27', '2024-09-26 18:46:27'),
(105, 'App\\Models\\User', 16, 'wallet', '94f88fed080ab0549f5abfeea8fffb9fae5ebdc147ed66493ae0106801e78396', '[\"*\"]', NULL, '2024-09-26 18:53:47', '2024-09-26 18:48:06', '2024-09-26 18:53:47'),
(106, 'App\\Models\\User', 2, 'wallet', '56cb3342ac9f6313e6b58cf55353ca9976dfec61848d6e5a09dbe8f2b721e8a5', '[\"*\"]', NULL, NULL, '2024-09-26 20:29:35', '2024-09-26 20:29:35'),
(107, 'App\\Models\\User', 2, 'wallet', '953a99768047fa29b4bee987b044589513052727da340b8bc012c43aedc2b5db', '[\"*\"]', NULL, NULL, '2024-09-26 20:30:35', '2024-09-26 20:30:35'),
(108, 'App\\Models\\User', 2, 'wallet', 'dcb1d1c354e851943406a14716896549b651b5dbe1345c385b7145ec3ebf4472', '[\"*\"]', NULL, NULL, '2024-09-26 20:33:17', '2024-09-26 20:33:17'),
(109, 'App\\Models\\User', 2, 'wallet', '4258f9e997b36be6485ea8853937cdbd7611ee60781c62b76880357b8a2149bb', '[\"*\"]', NULL, '2024-09-26 20:57:07', '2024-09-26 20:37:28', '2024-09-26 20:57:07'),
(110, 'App\\Models\\User', 2, 'wallet', '51311fa6f0794222c0c7bcbc9cd5f1488692a37facb562ca059633c4106207a3', '[\"*\"]', NULL, '2024-09-26 21:04:20', '2024-09-26 20:59:26', '2024-09-26 21:04:20'),
(111, 'App\\Models\\User', 17, 'wallet', '1e4642dd49d3396fc275b4eea7858bfbb495ba748c20d5c686be1e7353e325e9', '[\"*\"]', NULL, '2024-09-26 21:12:42', '2024-09-26 21:05:56', '2024-09-26 21:12:42'),
(112, 'App\\Models\\User', 2, 'wallet', 'c3fd5665a9e1f948c003bae4a777bf4c1a93029dfaa630e0de7d8c23eab3ff10', '[\"*\"]', NULL, '2024-09-26 21:24:11', '2024-09-26 21:18:24', '2024-09-26 21:24:11'),
(113, 'App\\Models\\User', 2, 'wallet', '74a16b7a48129ae141871f8fd36c337fb44082f26a19e35ab46c46892c44e7e5', '[\"*\"]', NULL, '2024-09-26 21:54:03', '2024-09-26 21:54:01', '2024-09-26 21:54:03'),
(114, 'App\\Models\\User', 17, 'wallet', '06ffe9255b10b771d38d408dfaa89110eb7a0c0e60f3d3997ccf9959c26df6a5', '[\"*\"]', NULL, '2024-09-26 22:13:18', '2024-09-26 21:57:08', '2024-09-26 22:13:18'),
(115, 'App\\Models\\User', 18, 'wallet', '6a03c607c073ce00175fd3aaa3676fc575ad45261cb6ff8d64c94190654a2b1c', '[\"*\"]', NULL, '2024-09-27 06:09:14', '2024-09-27 06:04:55', '2024-09-27 06:09:14'),
(116, 'App\\Models\\User', 20, 'wallet', '1781b90d0836689730cf57e5f11628661a17be205e5200439c2e4183ef5ac2fb', '[\"*\"]', NULL, NULL, '2024-10-01 06:41:59', '2024-10-01 06:41:59'),
(117, 'App\\Models\\User', 20, 'wallet', 'dd6fae8242e56d242e214dfbddaebc9b769c25b9704602bf945246b420326905', '[\"*\"]', NULL, NULL, '2024-10-01 06:53:59', '2024-10-01 06:53:59'),
(118, 'App\\Models\\User', 2, 'wallet', '1636d69c15aef472f5310d9a2fb12ed5befb55916c876375740e1e42af6aaf5a', '[\"*\"]', NULL, NULL, '2024-10-01 06:59:21', '2024-10-01 06:59:21'),
(119, 'App\\Models\\User', 20, 'wallet', '08297456af1741a1cd15e178a1ba0de68ff9eac264e0d33c21869110f6db74d9', '[\"*\"]', NULL, NULL, '2024-10-01 16:14:17', '2024-10-01 16:14:17'),
(120, 'App\\Models\\User', 20, 'wallet', '7ece8724f3a92023b7fab6a21bdd31764b251f5087e312f6536145aae78f8ecd', '[\"*\"]', NULL, '2024-10-08 21:58:51', '2024-10-01 16:17:00', '2024-10-08 21:58:51'),
(121, 'App\\Models\\User', 2, 'wallet', 'c1009201c0995852f46030875abec5fcd43dd16cb295729ba07fb64b0045361e', '[\"*\"]', NULL, '2024-10-01 18:03:12', '2024-10-01 17:58:10', '2024-10-01 18:03:12'),
(122, 'App\\Models\\User', 2, 'wallet', '4cf8ac90c583ea8ab5b70487b985769f41aed8cc20ad122cbf36163cf68c1f6d', '[\"*\"]', NULL, '2024-10-01 19:28:45', '2024-10-01 18:13:17', '2024-10-01 19:28:45'),
(123, 'App\\Models\\User', 2, 'wallet', 'd27a8c9cf28b356d60e7a7977ab916b6f978bb5a0a53a4cfc93480267c584c01', '[\"*\"]', NULL, '2024-10-01 19:36:49', '2024-10-01 19:33:59', '2024-10-01 19:36:49'),
(124, 'App\\Models\\User', 2, 'wallet', 'a3ad12935ffcd33c8be418d9ceffa0b8196366d69b1746e64df1a2cac8e22a62', '[\"*\"]', NULL, NULL, '2024-10-08 21:59:16', '2024-10-08 21:59:16'),
(125, 'App\\Models\\User', 2, 'wallet', '60466c7b9b2fb6a9da2ebb59eb96f634b5b7c435a79502e439e9115532b63ae9', '[\"*\"]', NULL, NULL, '2024-10-08 21:59:33', '2024-10-08 21:59:33'),
(126, 'App\\Models\\User', 2, 'wallet', '7196eb8b32aeea046368aa3796b8da5db7e4937aeca4239909b21aa79654d388', '[\"*\"]', NULL, NULL, '2024-10-08 21:59:37', '2024-10-08 21:59:37');
...
CREATE TABLE `request_money` (
  ...
  `charge` decimal(20,10) NOT NULL,
  `final_amount` decimal(20,10) NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 => pending, 1 => accepted, 2 => rejected',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'DBRbank: CMS de billetera avanzado con API de pasarela de pago', 'wallet,wallet cms', 'DBRbank: CMS de billetera avanzado con API de pasarela de pago', '15339411471646279600.png');
...
CREATE TABLE `site_contents` (
  ...
  `sub_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'banner', 'banner', '{\"title\":\"Simple. R\\u00e1pido. Seguro.\",\"heading\":\"Haga que la banca en l\\u00ednea sea m\\u00e1s f\\u00e1cil y c\\u00f3moda\",\"sub_heading\":\"Una cuenta internacional para enviar dinero a m\\u00e1s de 60 pa\\u00edses alrededor del mundo, hasta 7 veces m\\u00e1s barato que el banco\",\"button_1_name\":\"Empezar\",\"button_1_url\":\"\\/user\\/register\",\"button_2_name\":\"Contacta con nosotros\",\"button_2_url\":\"\\/contact\",\"image\":\"11485249001727036928.jpg\",\"image_size\":\"1320x880\"}', NULL, '1', NULL, '2024-09-23 00:28:48'),
(2, 'about\r\n', 'about', '{\"title\":\"Nosotros estamos seguros\",\"heading\":\"Somos Plataforma Segura y Estable\",\"short_details\":\"Porro illum impedit nemo hic, similique at, qui ducimus praesentium ullam voluptatem culpa temporibus eveniet, esse accusamus? \\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni esse quibusdam numquam.\",\"feature_1_icon\":\"fas fa-shipping-fast\",\"feature_1_title\":\"M\\u00e1s r\\u00e1pido y m\\u00e1s barato\",\"feature_1_details\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam\",\"feature_2_icon\":\"fas fa-user-shield\",\"feature_2_title\":\"De confianza y seguro\",\"feature_2_details\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam\",\"image_size\":\"700x570\",\"image\":\"12626417021644473699.png\"}', NULL, '1', NULL, '2024-09-27 21:26:40'),
(3, 'service\r\n', 'service', '{\"title\":\"Servicios\",\"heading\":\"Lo que le servimos\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', '[{\"icon\":\"far fa-money-bill-alt\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"},{\"icon\":\"fas fa-download\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"},{\"icon\":\"fas fa-upload\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"},{\"icon\":\"far fa-check-circle\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"},{\"icon\":\"fas fa-qrcode\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"},{\"icon\":\"fas fa-wallet\",\"title\":\"Cartera completa\",\"details\":\"Alias, tempore reiciendis deserunt beatae voluptatum quo quae cumque animi, excepturi maxime est.\"}]', '1', NULL, '2024-09-22 19:09:39'),
(4, 'how to\n', 'how', '{\"title\":\"C\\u00f3mo empezar\",\"heading\":\"\\u00a1Tenemos algunos pasos sencillos!\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\",\"image_size\":\"720x700\",\"image\":\"8838201231644403288.png\"}', '[{\"icon\":\"fas fa-user-plus\",\"title\":\"Reg\\u00edstrese en DBRBANK\",\"details\":\"Repellendus consequuntur vel nam numquam labore reiciendis rem neque eveniet, dicta molestias.\"},{\"icon\":\"fas fa-user-check\",\"title\":\"Verifique su cuenta\",\"details\":\"Repellendus consequuntur vel nam numquam labore reiciendis rem neque eveniet, dicta molestias.\"},{\"icon\":\"fas fa-exchange-alt\",\"title\":\"Realice transacciones ilimitadas\",\"details\":\"Repellendus consequuntur vel nam numquam labore reiciendis rem neque eveniet, dicta molestias.\"}]', '1', NULL, '2024-09-23 22:29:10'),
(5, 'Counter', 'counter', '{\"title\":\"Nuestras estad\\u00edsticas\",\"heading\":\"Nosotros estamos aqu\\u00ed desde 1998\",\"sub_heading\":\"Porro illum impedit nemo hic, similique at, qui ducimus praesentium ullam voluptatem culpa temporibus eveniet, esse accusamus? \\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis\",\"button_name\":\"Empezar\",\"button_url\":\"\\/user\\/register\"}', '[{\"icon\":\"fas fa-users\",\"title\":\"Clientes felices\",\"counter\":\"986M\"},{\"icon\":\"fas fa-exchange-alt\",\"title\":\"Transacciones totales\",\"counter\":\"854M\"},{\"icon\":\"fas fa-dollar-sign\",\"title\":\"Dep\\u00f3sito Total\",\"counter\":\"1524M\"},{\"icon\":\"fas fa-money-check-alt\",\"title\":\"Retiro Total\",\"counter\":\"4527M\"}]', '1', NULL, '2024-09-22 19:18:26'),
(6, 'Feature\r\n', 'feature', '{\"title\":\"Tus beneficios\",\"heading\":\"Elimine el estr\\u00e9s de administrar su billetera\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', '[{\"image_size\":\"128x128\",\"title\":\"Cobertura global\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"11228532431644465552.png\"},{\"image_size\":\"128x128\",\"title\":\"Tarifa m\\u00e1s baja\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"9520810491646279362.png\"},{\"image_size\":\"128x128\",\"title\":\"M\\u00e9todos de transferencia simples\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"4080473251644466179.png\"},{\"image_size\":\"128x128\",\"title\":\"Procesamiento instant\\u00e1neo\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"4808291231644466203.png\"},{\"image_size\":\"128x128\",\"title\":\"Seguridad a nivel bancario\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"18431945771644466228.png\"},{\"image_size\":\"128x128\",\"title\":\"Soporte global 24 horas al d\\u00eda, 7 d\\u00edas a la semana\",\"details\":\"Minus quasi quis nesciunt, porro sunt soluta laborum dolore voluptas natus ratione iste vel, rem neque earum, repellendus voluptate! Quam, soluci\\u00f3n.\",\"image\":\"13995404631644466245.png\"}]', '1', NULL, '2024-09-22 19:26:55'),
(7, 'FAQs\r\n', 'faq', '{\"title\":\"Preguntas frecuentes\",\"heading\":\"Preguntas frecuentes\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', '{\"0\":{\"question\":\"\\u00bfDeserunt hic consequatur ex placeat?\",\"answer\":\"Primero: Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSegundo: Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae oficia repellat maiores!\"},\"1\":{\"question\":\"\\u00bfDeserunt hic consequatur ex placeat?\",\"answer\":\"Primero: Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSegundo: Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae oficia repellat maiores!\"},\"3\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"4\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"5\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"6\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"7\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"8\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"},\"9\":{\"question\":\"Deserunt hic consequatur ex placeat?\",\"answer\":\"First : Aut, expedita optio? Quis ab laudantium, facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo?\\r\\n\\r\\nSecond : Facilis similique est alias, possimus expedita dolorum fugit mollitia, optio quo? Dignissimos beatae officia repellat maiores!\"}}', '0', NULL, '2024-09-22 19:31:10'),
(8, 'Testimonial', 'testimonial', '{\"title\":\"Testimonios\",\"heading\":\"Lo que los clientes dicen de nosotros\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', '[{\"image_size\":\"120x120\",\"name\":\"Peter Parker\",\"quote\":\"Incidunt maxime necessitatibus maiores voluptate, error vero velit, consequuntur ut porro cumque beatae sed repellendus in non nulla at\",\"image\":\"17542701511644467352.png\"},{\"image\":\"17081516131644467428.png\",\"image_size\":\"120x120\",\"name\":\"John Doe\",\"quote\":\"Incidunt maxime necessitatibus maiores voluptate, error vero velit, consequuntur ut porro  cumque beatae sed repellendus in non nulla at\"},{\"image\":\"13860206431644467446.png\",\"image_size\":\"120x120\",\"name\":\"Stephen Rodrick\",\"quote\":\"Incidunt maxime necessitatibus maiores voluptate, error vero velit, consequuntur ut porro  cumque beatae sed repellendus in non nulla at\"},{\"image\":\"7314344801644467467.png\",\"image_size\":\"120x120\",\"name\":\"Matt Damon\",\"quote\":\"Incidunt maxime necessitatibus maiores voluptate, error vero velit, consequuntur ut porro  cumque beatae sed repellendus in non nulla at\"}]', '1', NULL, '2024-09-22 19:32:55'),
(9, 'Blog', 'blog', '{\"title\":\"Publicaciones de blog\",\"heading\":\"Nuestras \\u00faltimas noticias y consejos\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', NULL, '1', NULL, '2024-09-22 19:33:57'),
(10, 'Sponsors', 'sponsors', '{\"title\":\"Patrocinadores\",\"heading\":\"Patrocinadores de la marca DBR BANK\",\"sub_heading\":\"\\u00a1Deserunt hic consequatur ex placeat! atque repellendus inventore quisquam, perferendis, eum reiciendis quia nesciunt fuga magni.\"}', '[{\"image\":\"4506843581646279391.png\",\"image_size\":\"260x200\"},{\"image\":\"4240436131646279399.png\",\"image_size\":\"260x200\"},{\"image\":\"6956855071646279421.png\",\"image_size\":\"260x200\"},{\"image\":\"3515199711644469859.png\",\"image_size\":\"260x200\"},{\"image\":\"18874078061644469864.png\",\"image_size\":\"260x200\"},{\"image\":\"5588095611644469870.png\",\"image_size\":\"260x200\"},{\"image\":\"8676066221646279428.png\",\"image_size\":\"260x200\"},{\"image\":\"13654331771646279436.png\",\"image_size\":\"260x200\"},{\"image\":\"2093287281644469889.png\",\"image_size\":\"260x200\"}]', '1', NULL, '2024-09-22 19:36:02'),
...
CREATE TABLE `support_tickets` (
  ...
  `ticket_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 = pending, 1 = replied. ',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(7, '2', '1', NULL, NULL, 'TKT18058591', 'salir', '0', '2024-10-01 19:27:40', '2024-10-01 19:27:40');
...
CREATE TABLE `transactions` (
  ...
  `user_type` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `wallet_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `zip` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `email_verified` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `verification_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_code` int DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc_status` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `kyc_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `kyc_reject_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `two_fa_status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `two_fa` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `two_fa_code` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'Marcelo Anjos', 'user@gmail.com', '18335353941697632725.jpg', '++595 993547294', 'Asuncion', 'dhaka', 'Uttara', '1230', '1', '1', NULL, 316447, '$2y$10$4NGIC.vnYXYjiK2amxPyFOG6g9pairnmZOmlhzxPAH8VXPQ0SqEr6', NULL, '1', '{\"nid\":\"22222222\",\"details\":{\"description_of_address\":\"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\"}}', 'test', '0', '0', 829383, '2023-09-25 23:53:55', '2024-10-08 21:59:37'),
(13, 'sonyc', 'sonycltda@gmail.com', NULL, '+5574988283353', 'Brazil', NULL, 'juazeiro', NULL, '1', '1', NULL, NULL, '$2y$10$t6.phuyBjin9Rd0s3OTGVejMA9X0Guz9SevJiXqYhIZDMDjdM.REy', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-09-23 01:38:25', '2024-09-23 01:38:25'),
(14, 'ruben', 'ruben@gmail.com', NULL, '+55119999999', 'Brazil', NULL, 'rua 1', NULL, '1', '1', NULL, NULL, '$2y$10$Pw3sqfZwrawgmuZYVN5LBeFQr/NbP1c1lXZxcQpxPokv42HnBlFMK', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-09-23 22:45:10', '2024-09-23 22:45:10'),
(15, 'adelino', 'ade.anjos@gmail.com', NULL, '+5511920150503', 'Brazil', NULL, 'user', NULL, '1', '1', NULL, 736638, '$2y$10$sZfIz5ZPGvFFlfN5uWh62.BU0O/LR8fCwmj.4Hom2WyhJKE3fE3s6', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-09-24 13:21:54', '2024-10-01 01:18:43'),
(16, 'marcelo', 'marcelu.ohd@gmail.com', NULL, '5511995009969', 'Brazil', NULL, 'run', NULL, '1', '1', NULL, 354059, '$2y$10$4RC85mENPLpxwXpVEEI8/evE6Sa8o1iuw2L/Sx33EW20dpEFlznMu', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-09-26 18:48:06', '2024-09-26 20:28:21'),
(17, 'Marcelo dos Anjos', 'marcelu.phd@gmail.com', '18335353941697632725.jpg', '+5511995009969', 'Brazil', 'Sao Paulo', 'Praia Grande', '0000', '1', '1', NULL, 351016, '$2y$10$xwGT2aUcAbkUbqT3ekOymOqkc2ZSDJoy6AkPtsEAoLATyFGNWbdh6', NULL, '1', '{\"nid\":\"8089161\",\"image\":{\"nid_screenshot\":\"1137498701727370223.png\"},\"details\":{\"description_of_address\":\"long beach sao paulo 123\"}}', NULL, '0', '0', 127696, '2024-09-26 21:01:39', '2024-10-08 22:53:25'),
(18, 'Andrea Anjis', 'andeeatanjos@gmail.com', NULL, '5511995009969', 'Brazil', NULL, 'Pg', NULL, '1', '1', NULL, NULL, '$2y$10$b8UuXFRuPzdyPvKG/gITNer/n05DLMoOUS9lTNQ0eyJDq7G.SgkLO', NULL, '1', '{\"nid\":\"8089161\",\"image\":{\"nid_screenshot\":\"18802436831727402758.jpg\"},\"details\":{\"description_of_address\":\"calle lafranconi 4685\"}}', NULL, '0', '0', NULL, '2024-09-27 06:04:55', '2024-09-27 06:08:32'),
(19, 'adelino anjos', 'adelinohenriqueanjos@gmail.com', NULL, '+5511920150503', 'Brazil', NULL, 'agent', NULL, '1', '1', NULL, NULL, '$2y$10$ul6rJFOi.ABFE8LNZyzufOGRAuys4tNWMC48xcr5C7Cfww4I6b.O2', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-10-01 01:26:26', '2024-10-01 01:26:26'),
(20, 'Marcelu Santos', 'marcelu@gmail.com', NULL, '5511995009960', 'Germany', NULL, 'calle 3', NULL, '1', '1', NULL, NULL, '$2y$10$Om9r6Gg7fxoCgYPbi4nhPOyB9W/CPz02Szj06WqU79QOtSjUMl1zi', NULL, '0', NULL, NULL, '0', '0', 252124, '2024-10-01 06:41:59', '2024-10-01 16:17:00'),
(21, 'Leandro Souza', 'leandro@gmail.com', NULL, '+4911995009969', 'Germany', NULL, 'street 45', NULL, '1', '0', NULL, NULL, '$2y$10$5PbYwGK25.ll00WDuO.UZ.JxHm1u1ciXO5uMpzH.ZtCOq0qW0yk.S', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-10-02 02:19:48', '2024-10-02 02:19:48'),
(22, 'qxjLkbDrxr', 'hhamishe1997@gmail.com', NULL, '6383124507', 'Brazil', NULL, 'qGSTiyFsIfzUuT', NULL, '1', '1', NULL, 282789, '$2y$10$RuAZUw7nbbbdkvgCn/gTouf5ABPr/BZTJKZdME5OPr80uncAkyZCG', NULL, '0', NULL, NULL, '0', '0', NULL, '2024-10-07 16:24:21', '2024-10-07 16:25:35');
...
CREATE TABLE `vouchers` (
  ...
  `amount` decimal(20,10) NOT NULL,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 => unused, 1 => used',
...
CREATE TABLE `wallets` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_type` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1 => user, 2 => ''merchant'', 3  => ''agent''',
...
(58, '13', '1', '15', '0.0000000000', '2024-09-23 01:38:25', '2024-09-23 01:38:25'),
(59, '14', '1', '15', '0.0000000000', '2024-09-23 22:45:10', '2024-09-23 22:45:10'),
(60, '15', '1', '15', '0.0000000000', '2024-09-24 13:21:54', '2024-09-24 13:21:54'),
(61, '16', '1', '15', '0.0000000000', '2024-09-26 18:48:07', '2024-09-26 18:48:07'),
(62, '17', '1', '15', '0.0000000000', '2024-09-26 21:01:39', '2024-09-26 21:01:39'),
(63, '18', '1', '15', '0.0000000000', '2024-09-27 06:04:55', '2024-09-27 06:04:55'),
(64, '19', '1', '15', '0.0000000000', '2024-10-01 01:26:26', '2024-10-01 01:26:26'),
(65, '20', '1', '4', '0.0000000000', '2024-10-01 06:41:59', '2024-10-01 06:41:59'),
(66, '21', '1', '4', '0.0000000000', '2024-10-02 02:19:49', '2024-10-02 02:19:49'),
(67, '22', '1', '15', '0.0000000000', '2024-10-07 16:24:21', '2024-10-07 16:24:21');
...
CREATE TABLE `withdrawals` (
  ...
  `user_data` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 => pending, 1 => accepted, 2 => rejected\r\n',
  `reject_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `withdraws` (
  ...
  `currency_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `withdraw_instruction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
