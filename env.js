 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.dbrbank.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.dbrbank'; // ios bundle id
const PACKAGE = 'com.dbrbank'; // android package name
const NAME = 'dbrbank'; // app name
const EXPO_ACCOUNT_OWNER = 'senaiapy'; // expo account owner
const EAS_PROJECT_ID = 'e846542a-0805-4bd9-a0f1-b2ad45a45170'; // eas project id
const SCHEME = 'dbrbank'; // app scheme
